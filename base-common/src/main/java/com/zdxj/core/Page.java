...
public class Page<T> implements Serializable {
     ...
     * 要想使用此类，必须提供2个参数
     *
     * @param firstResultIndex  开始记录数
     * @param totalRecords 总记录条数
     */
    public Page(int firstResultIndex, int pageSize ,int totalRecords) {
        this.startIndex = firstResultIndex;
        this.pageSize = pageSize;
        this.totalRecords = totalRecords;
        //计算开始记录索引
        this.currentPage = (firstResultIndex/pageSize)+1;
        //计算总页数
